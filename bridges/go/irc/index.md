# mautrix-irc
Welcome to the mautrix-irc docs!
...
header. Things specific to mautrix-irc are under this page.
...
If you run a public instance and wish to list it here, please [make a pull request](https://github.com/mautrix/docs/blob/master/bridges/go/irc/index.md).
